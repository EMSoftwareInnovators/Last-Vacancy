...
export const BARKS = {
  ...
  vendOut: ['Sold out. Of course it\'s sold out.', '(pushes the button again, as if that will help)', 'Out. Out. What isn\'t out?'],
  vendFull: ['It won\'t take the quarter. It just gives it back.', '(the coins rattle through into the return, again)'],
  soapOut: ['No soap. The soap machine\'s out of soap.', '(bangs the soap machine) Nothing.'],
